...
* `DirectedTransport.trivialCycleLabels_iff_chosen_root_return_tests` and
  `DirectedTransport.hasTrivialCycleLabels_iff_parallelLabels`: reformulations of flatness
...
* `DirectedTransport.existsUnique_normalizedUnitPotential_of_trivialCycleLabels`: the
