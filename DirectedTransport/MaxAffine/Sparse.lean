...
* `DirectedTransport.MaxAffineTransport.branchHalfspace`: the closed halfspace of candidate
...
* `DirectedTransport.MaxAffineTransport.exists_sparse_rational_farkas_certificate`,
  `DirectedTransport.MaxAffineTransport.exists_sparse_integral_farkas_certificate`: the same
...
* `DirectedTransport.MaxAffineTransport.exists_rankSparse_normalizedBranchCertificate`: a
...
* `DirectedTransport.MaxAffineTransport.exists_positiveBranchCircuit_of_infeasible`:
