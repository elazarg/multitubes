...
walks.  `Maths.DirectedTransport.Additive.Exact` specializes this file to translation
maps, where cycle sums are translation holonomy and coboundaries are sections,
and `Maths.DirectedTransport.MaxAffine.Basic` specializes it to monotone max-affine
