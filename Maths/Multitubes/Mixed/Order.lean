...
/-!
# Ordered mixed transport

The order-theoretic surface of mixed transport uses the fiberwise
...
transport, mixed polarity, lax section, oplax section, order
-/
